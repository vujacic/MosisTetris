...
public class ShapeT extends GameObject {
    public ShapeT(TetrisGrid tg) {
        super(tg);
        setGridLocation();
        //setRectLocation();
        setWallKickData();
...
//            loc+=1;
//        }
        gridLocation = new int[]{0,4,1,3,1,4,1,5};
    }
...
//        }
    ...
    public void setPaint() {
        ...
        this.paint  = PaintObjects.PaintColors.purple;
        this.oldPaint = PaintObjects.PaintColors.purple;
